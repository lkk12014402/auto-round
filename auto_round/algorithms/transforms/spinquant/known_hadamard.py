...
# Ported from Quark (AMD) — pre-computed Hadamard matrices for non-power-of-2 sizes.
#
# These matrices enable Hadamard decomposition for dimensions like
# 3072 = 12 × 256, where the 12×12 block is a known Hadamard matrix
# and 256 is handled by butterfly decomposition.
#
