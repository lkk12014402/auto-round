...
output_dir = "./Llama-3.1-8B-Instruct_autoround_iters200_mxfp4_transformed"
...
ar = AutoRound(model_name_or_path, scheme="MXFP4", iters=200, transform_config={"transform_class": "hadamard"})
#ar = AutoRound(model_name_or_path, scheme="MXFP4", iters=0)
# print(ar)
# exit()
