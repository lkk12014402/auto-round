...
class RotationConfig(BaseModel, BaseRotationConfig):
    ...
    # ---- selective rotation ----
    # Controls which layers receive per-linear Hadamard rotation.
    #   "all"        – apply to every Linear layer (legacy default)
    #   "structural" – use structural priors (skip lm_head, down_proj, o_proj, etc.)
    #   "auto"       – combine structural priors with activation-profiling statistics
