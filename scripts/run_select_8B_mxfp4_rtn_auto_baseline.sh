...
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_rotation_module_compare.py --device cuda:0 --variants had_auto --model Qwen/Qwen3-8B --quant-iters 0 --tasks piqa
