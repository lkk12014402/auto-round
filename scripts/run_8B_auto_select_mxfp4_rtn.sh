...
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_selective_rotation_save_vllm.py --model Qwen/Qwen3-8B --output auto_selective_rotation_mxfp4_model_8B --layer-selection auto
