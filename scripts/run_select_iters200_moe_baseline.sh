...
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_selective_rotation.py --moe --device cuda:0 --variants none --model Qwen/Qwen3-30B-A3B-Instruct-2507 --quant-iters 0 --tasks gsm8k --limit 100
