...
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_rotation_module_compare.py --device cuda:4 --variants had_auto --model Qwen/Qwen3-8B --quant-iters 200 --tasks mmlu,gsm8k,piqa,hellaswag >> iters200.log 2>&1 &
