...
#SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_selective_rotation.py --moe --device cuda:0 --variants had_auto --model Qwen/Qwen3-30B-A3B-Instruct-2507 --quant-iters 200 --tasks mmlu,gsm8k,piqa,hellaswag >> iters200_auto_moe.log 2>&1 &
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_selective_rotation.py --moe --device cuda:0 --variants had_auto --model Qwen/Qwen3-30B-A3B-Instruct-2507 --quant-iters 0 --tasks gsm8k --limit 100
