...
SELECTIVE_ROTATION_LOG_LEVEL=DEBUG python test_rotation_module_compare.py --device cuda:5 --variants none,had_auto --model Qwen/Qwen3-0.6B --quant-iters 200 --tasks mmlu,gsm8k,piqa,hellaswag >> iters200_0.6B.log 2>&1 &
