...
from auto_round_extension.vllm_ext.mxfp4_qdq_utils import qdq_mxfp4 as _unified_qdq_mxfp4
...
def _spinquant_mxfp4_act_qdq_impl(x: torch.Tensor, group_size: int) -> torch.Tensor:
    ...
    Delegates to the unified mxfp4_qdq_utils.qdq_mxfp4() which handles backend
    dispatch (local_ext > triton > fallback) and AUTO_ROUND_MXFP4_QDQ_BACKEND env var.
    """
